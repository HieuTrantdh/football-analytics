...
-- Muc dich:
--    Chua cac stored procedure cua he thong football_db
-- Bao gom:
--    1. GetStandings
--    2. GetHeadToHead
--    3. GetTopPlayerBySeason
--    4. GetTeamHistory
-- ============================================================
...
-- SP 1: GetStandings
-- Muc dich:
--    Tra ve bang xep hang cua mot giai dau trong mot mua giai
-- Cach su dung:
--    Nguoi dung truyen vao ten giai dau (p_league_name)
--    va mua giai (p_year) de xem bang xep hang
-- Vi du:
--    CALL GetStandings('England Premier League', '2015/2016');
-- ============================================================
delimiter $$
...
-- SP 2: GetHeadToHead
-- Muc dich:
--    Tra ve lich su doi dau truc tiep giua 2 doi bong
-- Cach su dung:
--    Nguoi dung truyen vao ten 2 doi (p_team1_name, p_team2_name)
--    de xem toan bo lich su tran dau giua 2 doi
-- Vi du:
--    CALL GetHeadToHead('Arsenal', 'Chelsea');
-- ============================================================
delimiter $$
...
-- ============================================================
-- SP 3: GetTopPlayerBySeason
-- Muc dich:
--    Tra ve danh sach top cau thu xep hang theo rating
--    trong mot mua giai cu the
-- Cach su dung:
--    Nguoi dung truyen vao mua giai (p_season_year)
--    va so luong cau thu muon xem (p_top_n)
-- Vi du:
--    CALL GetTopPlayerBySeason('2015/2016', 10);
-- ============================================================
delimiter $$
...
-- SP 4: GetTeamHistory
-- Muc dich:
--    Tra ve lich su thi dau cua mot doi bong qua cac mua giai
-- Cach su dung:
--    Nguoi dung truyen vao ten doi bong (p_team_name)
--    de xem thanh tich qua tung mua giai
-- Vi du:
