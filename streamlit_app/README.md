...
Thư mục này chứa ứng dụng Streamlit cho dự án "Phân Tích Bóng Đá Châu Âu". Ứng dụng cung cấp giao diện tương tác để khám phá dữ liệu bóng đá, bao gồm bảng xếp hạng, so sánh đối đầu, cầu thủ xuất sắc, lịch sử đội bóng và tổng quan.
...
1. **Cài đặt thư viện**:
   Di chuyển đến thư mục gốc của dự án và cài đặt các thư viện cần thiết (các thư viện này nằm trong file 
   requirements.txt):
   ```bash
...
2. Chạy ứng dụng Streamlit:
   ...
   Ứng dụng sẽ tự động mở trong trình duyệt. Theo mặc định, ứng dụng sẽ khả dụng tại:
   ```
   http://localhost:8501
   ```
